...
st.subheader('Application réalisée par Cheikh Oumar Niass, Alassane Coly, Marie Fall et Ramatoulay katy Baldé')
st.markdown("Cette application affiche différents prix d'une maison ")
...
if st.button("Predict"):
    prediction = inference(bedroomabvgr, lotarea, overallqual, yearbuilt, yearremodadd, totalbsmtsf, grlivarea,
                           fullbath, garagecars)
    #resultat = "Le prix (en dollars) de cette maison est égal à : $" + str(prediction[0])
